...
En paralelo la comunidad estadística ha reconocido la importancia de asegurar la información para mantener la confianza de las poblaciones a las que servimos. En este sentido, nos adherimos como región al Código Nacional de Buenas Prácticas de Naciones Unidas, en su principio 7 sobre confidencialidad estadística, establece que la "agencias de estadística deben garantizar que la privacidad de los proveedores de datos (personas, hogares, empresas y otros proveedores de datos) esté protegida y que la información que brinden se mantendrá confidencial, no podrán acceder usuarios no autorizados internos o externos y será utilizada únicamente con fines estadísticos" [@nacionesunidas].
...
La publicación de datos es importante, ya que permite a los investigadores y responsables políticos replicar los resultados publicados oficialmente, generar nuevos conocimientos sobre los problemas.
